 ...
 */
public class ServerlessBackboneEventSource<T extends CustomResource<?,?>> extends AbstractEventSource
...
//    private Map<CustomResourceID,CloudEvent> submittedForProcessing;
    ...
    public Optional<T> getCustomResource(CustomResourceID resourceID) {
        return Optional.ofNullable(controller.getCRClient().inNamespace(resourceID.getNamespace().orElse(null))
